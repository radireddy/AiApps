...
# Gemini Low-Code App Builder: Developer Guide
...
The goal of this project is to create a highly extensible, user-friendly, low-code/no-code application builder. It leverages the power of the Google Gemini API for AI-driven layout generation and provides a flexible plugin system for adding new UI components and data providers.
...
2.  Add your API key to this file:
    ...
    ```
    This key is loaded automatically by the application.
