  ...
  return (
    <div className="flex items-center gap-3 p-3 bg-white border-b border-gray-200 shrink-0">
      <div className="flex items-center gap-1.5 text-yellow-500 bg-yellow-100/80 px-2 py-1 rounded-full" aria-hidden="true">
          ...
          <span className={`${typography.semibold} ${typography.caption} uppercase tracking-wide`}>AI</span>
      </div>
      <input
        type="text"
        value={prompt}
        ...
        className={`flex-grow bg-white border border-gray-300 rounded-md p-2 ${typography.body} text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500`}
        disabled={isLoading}
      ...
      <button
        ...
        className={`px-4 py-2 ${typography.body} ${typography.semibold} text-white bg-indigo-600 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-gray-400 disabled:cursor-not-allowed transition-all`}
