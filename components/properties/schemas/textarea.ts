...
const textareaProperties: PropertyMetadata[] = [
  // General Tab - Value and Basic Properties
  {
    ...
    tooltip: 'Current value of the textarea (supports expressions). Alternative to dataStoreKey.',
  ...
  },
  {
    ...
    propertyOrder: 1,
    applicableTo: [ComponentType.TEXTAREA],
    tooltip: 'Key in dataStore where textarea value is saved (e.g., user.message)',
