...
describe('RenderedComponent Selection', () => {
  ...
  describe('Panel Component Selection', () => {
    ...
    it('should be selectable when enabled', () => {
      render(<RenderedComponent component={panelComponent} {...baseProps} />);
      const wrapper = screen.getByLabelText('PANEL component');
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('panel1', expect.any(Object));
    });

    it('should be selectable when disabled', () => {
      const disabledPanel = {
        ...panelComponent,
        props: { ...panelComponent.props, disabled: true },
      };
      render(<RenderedComponent component={disabledPanel} {...baseProps} />);
      const wrapper = screen.getByLabelText('PANEL component');
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('panel1', expect.any(Object));
    });
    ...
    it('should be selectable when hidden', () => {
      const hiddenPanel = {
        ...panelComponent,
        props: { ...panelComponent.props, hidden: true },
      };
      render(<RenderedComponent component={hiddenPanel} {...baseProps} />);
      const wrapper = screen.getByLabelText('PANEL component');
      expect(wrapper).toBeInTheDocument();
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('panel1', expect.any(Object));
  ...
  describe('HStack Component Selection', () => {
    ...
    it('should be selectable when enabled', () => {
      render(<RenderedComponent component={hStackComponent} {...baseProps} />);
      const wrapper = screen.getByLabelText('H_STACK component');
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('hstack1', expect.any(Object));
    });

    it('should be selectable when disabled', () => {
      const disabledHStack = {
        ...hStackComponent,
        props: { ...hStackComponent.props, disabled: true },
      };
      render(<RenderedComponent component={disabledHStack} {...baseProps} />);
      const wrapper = screen.getByLabelText('H_STACK component');
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('hstack1', expect.any(Object));
    });
    ...
    it('should be selectable when hidden', () => {
      const hiddenHStack = {
        ...hStackComponent,
        props: { ...hStackComponent.props, hidden: true },
      };
      render(<RenderedComponent component={hiddenHStack} {...baseProps} />);
      const wrapper = screen.getByLabelText('H_STACK component');
      expect(wrapper).toBeInTheDocument();
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('hstack1', expect.any(Object));
  ...
  describe('VStack Component Selection', () => {
    ...
    it('should be selectable when enabled', () => {
      render(<RenderedComponent component={vStackComponent} {...baseProps} />);
      const wrapper = screen.getByLabelText('V_STACK component');
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('vstack1', expect.any(Object));
    });

    it('should be selectable when disabled', () => {
      const disabledVStack = {
        ...vStackComponent,
        props: { ...vStackComponent.props, disabled: true },
      };
      render(<RenderedComponent component={disabledVStack} {...baseProps} />);
      const wrapper = screen.getByLabelText('V_STACK component');
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('vstack1', expect.any(Object));
    });
    ...
    it('should be selectable when hidden', () => {
      const hiddenVStack = {
        ...vStackComponent,
        props: { ...vStackComponent.props, hidden: true },
      };
      render(<RenderedComponent component={hiddenVStack} {...baseProps} />);
      const wrapper = screen.getByLabelText('V_STACK component');
      expect(wrapper).toBeInTheDocument();
      fireEvent.mouseDown(wrapper);
      expect(mockOnSelect).toHaveBeenCalledWith('vstack1', expect.any(Object));
