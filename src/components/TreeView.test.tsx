...
describe('TreeView Component Selection', () => {
  ...
  describe('Panel Component Selection in TreeView', () => {
    const appDefinition = createAppDefinition([
      {
        id: 'panel1',
    ...
    it('should be selectable when enabled', () => {
      render(<TreeView appDefinition={appDefinition} {...baseProps} />);
      const panelNode = screen.getByText('Panel');
      fireEvent.click(panelNode);
      expect(mockOnSelectComponent).toHaveBeenCalledWith('panel1', 'page1');
    });
  ...
  describe('Form Component Selection in TreeView', () => {
    const appDefinition = createAppDefinition([
      {
        id: 'form1',
    ...
    it('should be selectable when enabled', () => {
      render(<TreeView appDefinition={appDefinition} {...baseProps} />);
      const formNode = screen.getByText('Form');
      fireEvent.click(formNode);
      expect(mockOnSelectComponent).toHaveBeenCalledWith('form1', 'page1');
    });
  ...
  describe('HStack Component Selection in TreeView', () => {
    const appDefinition = createAppDefinition([
      {
        id: 'hstack1',
    ...
    it('should be selectable when enabled', () => {
      render(<TreeView appDefinition={appDefinition} {...baseProps} />);
      const hstackNode = screen.getByText('Horizontal Panel');
      fireEvent.click(hstackNode);
      expect(mockOnSelectComponent).toHaveBeenCalledWith('hstack1', 'page1');
    });
  ...
  describe('VStack Component Selection in TreeView', () => {
    const appDefinition = createAppDefinition([
      {
        id: 'vstack1',
    ...
    it('should be selectable when enabled', () => {
      render(<TreeView appDefinition={appDefinition} {...baseProps} />);
      const vstackNode = screen.getByText('Vertical Panel');
      fireEvent.click(vstackNode);
      expect(mockOnSelectComponent).toHaveBeenCalledWith('vstack1', 'page1');
    });
  ...
  describe('Modal Component Selection in TreeView', () => {
    const appDefinition = createAppDefinition([
      {
        id: 'modal1',
    ...
    it('should be selectable when enabled', () => {
      render(<TreeView appDefinition={appDefinition} {...baseProps} />);
      const modalNode = screen.getByText('Modal');
      fireEvent.click(modalNode);
      expect(mockOnSelectComponent).toHaveBeenCalledWith('modal1', 'page1');
    });
